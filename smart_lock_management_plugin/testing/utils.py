"""
Utility functions for testing smart_lock_management_plugin.
...
def create_test_user(username: str | None = None, permissions: list[str | None] = None,
    ...
    Example:
        ...
        ...     permissions=['smart_lock_management_plugin.view_smartlockmanagementplugin']
        ... )
    """
    if username is None:
...
def post_data(data: dict[str, Any]) -> dict[str, Any]:
    ...
    Example:
        ...
        >>> obj = Smart_Lock_Management_Plugin.objects.first()
...
def get_deletable_objects(instances):
    ...
    Example:
        >>> objs = Smart_Lock_Management_Plugin.objects.filter(name__startswith='test')
        >>> deletions = get_deletable_objects(objs)
        >>> # deletions = {'Smart_Lock_Management_Plugin': 3, 'RelatedModel': 5}
    """
...
def assert_object_changes(test_case, instance, action: str,
    ...
    Example:
        ...
        >>> obj = Smart_Lock_Management_Plugin.objects.create(name='Test')
