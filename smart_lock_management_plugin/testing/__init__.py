"""
Standalone testing base classes for smart_lock_management_plugin.
    ...
    def add_permissions(self, *permissions: str):
        ...
        Args:
            *permissions: Permission names in format "app.action_model"
                         e.g., "smart_lock_management_plugin.add_smartlockmanagementplugin"
...
class PluginViewTestCase(PluginModelTestCase):
    ...
    def _get_base_url(self) -> str:
        ...
        Returns:
            Base URL string (e.g., "plugins:smart_lock_management_plugin:smartlockmanagementplugin")
        """
