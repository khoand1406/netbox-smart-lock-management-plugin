...
### Release Summary
Initial release of smart_lock_management_plugin. This is a **minor** release introducing basic functionality for managing smart_lock_management_plugin resources in NetBox.

### Added
- Initial plugin structure with Smart_Lock_Management_Plugin model
